...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspInit 0 */
    ...
    PC1     ------> ADC_IN11
    */
    GPIO_InitStruct.Pin = Sharp_left_ADC_Pin|Sharp_right_ADC_Pin;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PC1     ------> ADC_IN11
    */
    HAL_GPIO_DeInit(GPIOC, Sharp_left_ADC_Pin|Sharp_right_ADC_Pin);
...
void HAL_TIM_IC_MspInit(TIM_HandleTypeDef* htim_ic)
{
  ...
  /* USER CODE END TIM1_MspInit 0 */
    ...
    PA11     ------> TIM1_CH4
    */
    GPIO_InitStruct.Pin = back_PING_Sensor_Echo_Pin|front_PING_Sensor_Echo_Pin;
...
void HAL_TIM_IC_MspDeInit(TIM_HandleTypeDef* htim_ic)
{
  ...
  /* USER CODE END TIM1_MspDeInit 0 */
    ...
    PA11     ------> TIM1_CH4
    */
    HAL_GPIO_DeInit(GPIOA, back_PING_Sensor_Echo_Pin|front_PING_Sensor_Echo_Pin);
...
void HAL_UART_MspInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END USART3_MspInit 0 */
    ...
    PB11     ------> USART3_RX
    */
    GPIO_InitStruct.Pin = UR_TX_DFPlayer_RX_Pin|UR_RX_DFPlayer_TX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
  ...
  /* USER CODE END USART4_MspInit 0 */
    ...
    PA1     ------> USART4_RX
    */
    GPIO_InitStruct.Pin = Rasp_Pi_RX_Pin|Rasp_Pi_TX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END USART3_MspDeInit 0 */
    ...
    PB11     ------> USART3_RX
    */
    HAL_GPIO_DeInit(GPIOB, UR_TX_DFPlayer_RX_Pin|UR_RX_DFPlayer_TX_Pin);
  ...
  /* USER CODE END USART4_MspDeInit 0 */
    ...
    PA1     ------> USART4_RX
    */
    HAL_GPIO_DeInit(GPIOA, Rasp_Pi_RX_Pin|Rasp_Pi_TX_Pin);
